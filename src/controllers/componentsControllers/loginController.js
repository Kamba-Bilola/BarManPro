...
import { handleAddToDatastoreObject,handleRemoveDatabase,handleClearData,createDatabase, appDefaultConfData, addToObjectStoreExec,checkIfDatabaseExists,clearAllDataExec, removeDatabaseExec, getLastIdAndSet } from '../databaseControllers/indexedDbCrud';
import { auth } from '../databaseControllers/firebase';
...
const HandleLogout = async (dispatch) => {
  ...
  try {
    ...
    setUserDetails(null); // Clear user state in Redux
